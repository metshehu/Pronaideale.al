...
builder.Services.AddScoped<IAgendsRepository,AgendsRepository>();
builder.Services.AddScoped<IPropertyRepositroy,PropertyRepostiroy>();
builder.Services.AddScoped<ICompanyRepository,CompanysRepository>();
builder.Services.AddScoped<IUserAgendsRepository,UserAgendsRepository>();
